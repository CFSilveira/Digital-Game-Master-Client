...
function Game2() {
  ...
  const fetchAreas = async () => {
    try {
      let response = await axios.get(`${process.env.REACT_APP_API_URL}/adventure/${adventureId}/${areas._step}`);
  ...
  return (
    <div className='Area-card'>
      ...
      <Link className='fake-button' to={`/adventure/game/${adventure._id}/1B`}>Start adventure</Link>
      </>
      }
